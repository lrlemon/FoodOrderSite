...
<html>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1 class="text-center"><br> Welcome to <span class="edit">Khudalagse* </span></h1>
     <br>
   <p class="text-center">Login Here</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn"><span  aria-hidden="true"></label>
            </span>
              </span>
            </div>           
          </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn"><span  aria-hidden="true"></span></label>
            </span>
       ...
       <label style="margin-left: 5px;"><a href="managersignup.php">Create a new account? Login</a></label>
