...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span ></span> Cart
             (<?php
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn"><span ></span></button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span ></span> Payment</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Your Cart</h1>
        <p class="text-center"><a href="foodlist.php">order now.</a></p>
